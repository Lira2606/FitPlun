                ...
                <nav className="bottom-nav bg-gray-900/50 backdrop-blur-md border-t border-gray-700/50 mt-auto" style={{ backgroundColor: 'rgba(2, 6, 23, 0.7)' }}>
                 ...
                 {splashVisible && (
                    <div id="splash-screen">
                        {showSplashIcon && (
                            <svg className="splash-icon w-32 h-32 text-cyan-400" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path d="M20.57,14.85c-0.34,1.44-1.2,2.7-2.39,3.67c-1.19,0.97-2.67,1.48-4.18,1.48s-2.99-0.51-4.18-1.48 c-1.19-0.97-2.05-2.23-2.39-3.67c-0.2-0.84-0.2-1.85,0-2.7c0.34-1.44,1.2-2.7,2.39-3.67c1.19-0.97,2.67-1.48,4.18-1.48 s2.99,0.51,4.18,1.48c1.19,0.97,2.05,2.23,2.39,3.67C20.77,13,20.77,14.01,20.57,14.85z M12,8.5c-1.93,0-3.5,1.57-3.5,3.5 s1.57,3.5,3.5,3.5s3.5-1.57,3.5-3.5S13.93,8.5,12,8.5z" />
                                <path d="M3.93,8.5C3.32,8.88,2.77,9.39,2.34,10C2.1,10.33,1.9,10.68,1.72,11.05C1.5,11.5,1.38,12,1.3,12.51H1.5 c0.54,0,1.05-0.17,1.48-0.45l0,0c0,0,0,0,0,0c0.43-0.28,0.78-0.63,1.06-1.02c0.28-0.39,0.48-0.82,0.59-1.27 C4.62,9.3,4.5,8.81,4.2,8.42C4.12,8.45,4.03,8.47,3.93,8.5z" />
                                <path d="M22.7,11.05c-0.18-0.37-0.38-0.72-0.62-1.05c-0.43-0.61-0.98-1.12-1.59-1.5C20.03,8.47,19.88,8.45,19.8,8.42 c-0.3,0.39-0.42,0.88-0.3,1.35c0.11,0.45,0.31,0.88,0.59,1.27c0.28,0.39,0.63,0.74,1.06,1.02c0,0,0,0,0,0l0,0 c0.43,0.28,0.94,0.45,1.48,0.45h0.2C22.62,12,22.5,11.5,22.7,11.05z" />
                            </svg>
                        )}
                    </div>
                )}
