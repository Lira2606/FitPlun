...
export default function Home() {
  useEffect(() => {
    ...
    const exerciseNameInput = document.getElementById('exercise-name') as HTMLInputElement;
    ...
    if (workoutList) workoutList.addEventListener('click', handleListClick);

    renderWorkoutList();

    return () => {
      if (form) form.removeEventListener('submit', handleSubmit);
      if (workoutList) workoutList.removeEventListener('click', handleListClick);
    };
  }, []);
                ...
                <div className="space-y-8">
                    ...
                    <div className="gradient-border">
                        <div className="gradient-border-content">
                            ...
                            <form id="add-exercise-form" className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="text" id="exercise-name" name="exercise-name" placeholder="Ex: Supino Reto" required className="w-full bg-gray-700/50 border border-gray-600 rounded-lg pl-10 pr-4 py-2.5 text-white focus:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-200" />
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input type="number" id="exercise-sets" name="exercise-sets" placeholder="Ex: 4" required className="w-full bg-gray-700/50 border border-gray-600 rounded-lg pl-10 pr-4 py-2.5 text-white focus:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-200" />
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input type="text" id="exercise-reps" name="exercise-reps" placeholder="Ex: 8-12" required className="w-full bg-gray-700/50 border border-gray-600 rounded-lg pl-10 pr-4 py-2.5 text-white focus:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-200" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <textarea id="exercise-notes" name="exercise-notes" rows={3} placeholder="Ex: Aumentar a carga..." className="w-full bg-gray-700/50 border border-gray-600 rounded-lg pl-10 pr-4 py-2.5 text-white focus:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-200"></textarea>
                                    </div>
                                </div>
                            ...
                            <div id="workout-list-container" className="flex-grow">
                                <div id="empty-state" className="text-center py-8 text-gray-500 transition-opacity duration-300">
                                    <svg className="mx-auto h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                        <path vector-effect="non-scaling-stroke" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                                    </svg>
                                    <p className="mt-3 text-sm">Nenhum exercício adicionado.</p>
                                </div>
                                <ul id="workout-list" className="space-y-3"></ul>
                            </div>
