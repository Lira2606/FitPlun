                                            ...
                                            <div className="flex-grow space-y-4">
                                              <div>
                                                  ...
                                                  <div className="relative">
                                                      ...
                                                      <input type="text" id="exercise-name" name="exercise-name" placeholder="Ex: Supino Reto" required className="w-full bg-gray-700/60 border border-gray-600 rounded-lg pl-10 pr-4 py-2.5 text-white focus:bg-gray-700/60 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-200" />
                                                  </div>
                                              </div>
                                              <div className="grid grid-cols-2 gap-4">
                                                  <div>
                                                      ...
                                                      <div className="relative">
                                                          ...
                                                          <input type="number" id="exercise-sets" name="exercise-sets" placeholder="Ex: 4" required className="w-full bg-gray-700/60 border border-gray-600 rounded-lg pl-10 pr-4 py-2.5 text-white focus:bg-gray-700/60 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-200" />
                                                      </div>
                                                  </div>
                                                  <div>
                                                      ...
                                                      <div className="relative">
                                                          ...
                                                          <input type="text" id="exercise-reps" name="exercise-reps" placeholder="Ex: 8-12" required className="w-full bg-gray-700/60 border border-gray-600 rounded-lg pl-10 pr-4 py-2.5 text-white focus:bg-gray-700/60 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-200" />
                                                      </div>
                                                  </div>
                                              </div>
                                              <div className="grid grid-cols-2 gap-4">
                                                  <div>
                                                      ...
                                                      <div className="relative">
                                                          ...
                                                          <input type="text" id="exercise-weight" name="exercise-weight" placeholder="Ex: 40kg" className="w-full bg-gray-700/60 border border-gray-600 rounded-lg pl-10 pr-4 py-2.5 text-white focus:bg-gray-700/60 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-200" />
                                                      </div>
                                                  </div>
                                                  <div>
                                                      ...
                                                      <div className="relative">
                                                          ...
                                                          <input type="text" id="exercise-time" name="exercise-time" placeholder="Ex: 30s" className="w-full bg-gray-700/60 border border-gray-600 rounded-lg pl-10 pr-4 py-2.5 text-white focus:bg-gray-700/60 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-200" />
                                                      </div>
                                                  </div>
                                              </div>
                                              <div>
                                                  ...
                                                  <div className="relative">
                                                      ...
                                                      <textarea id="exercise-notes" name="exercise-notes" rows={3} placeholder="Ex: Aumentar a carga..." className="w-full bg-gray-700/60 border border-gray-600 rounded-lg pl-10 pr-4 py-2.5 text-white focus:bg-gray-700/60 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-200"></textarea>
                                                  </div>
                                              </div>
                                            </div>
