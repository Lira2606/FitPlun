                                            ...
                                            <div className="flex-grow space-y-4">
                                              <div>
                                                  ...
                                                  <div className="relative">
                                                      ...
                                                      <input type="text" id="exercise-name" name="exercise-name" placeholder="Ex: Supino Reto" required className="w-full bg-gray-700/80 border border-gray-600 rounded-lg pl-10 pr-4 py-2.5 text-white focus:bg-gray-700/80 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-200" />
                                                  </div>
                                              </div>
